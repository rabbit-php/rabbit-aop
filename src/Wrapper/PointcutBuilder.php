...
use Go\Aop\Framework\AfterReturnInterceptor;
...
class PointcutBuilder
{
    ...
    /**
     * Declares the "AfterReturn" hook for specific pointcut expression
     */
    public function afterReturn(string $pointcutExpression, Closure $adviceToInvoke): void
    {
        $interceptor = new AfterReturnInterceptor($adviceToInvoke, 0, $pointcutExpression);
        $this->registerAdviceInContainer($pointcutExpression, $interceptor);
    }
